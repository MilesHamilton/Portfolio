    ...
    return (
      <div className='about'>
        ...
        <div className='about-contents'>
          ...
          <p>
            I've always been <strong> tickering </strong>, tearing things apart,
            and building them anew. As a child, I enjoyed figuring out how
            ...
            booting up operating systems I had litte knowledge of just to learn
            how they worked.
          </p>
        </div>
        <div className='about-contents'>
          ...
          <p>
            ...
            niche
            <strong> skills and expertise</strong> along the way. My deployment
            to kuwait brought on a lot of challenges, but came with it the
            oppurtity to grow.
          </p>
        </div>
        <div className='about-contents'>
          <i class='material-icons small a'>landscape</i>
          <p>
        ...
        <div className='about-contents'>
          <i class='material-icons small a'>polymer</i>
          <p>
            ...
            like passions and creativity that had brought me so much joy as a
            kid.
          </p>
        </div>
        <div className='about-contents'>
          <i class='material-icons small a'>laptop_mac</i>
          <p>
